...
class QualificationTable
{
    ...
    /**
     * @var \AppBundle\Entity\QualificationEquivalence
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\QualificationEquivalence")
     * @ORM\JoinColumns({
     ...
     * Set equivalence
     *
     * @param \AppBundle\Entity\QualificationEquivalence $equivalence
     *
     * @return QualificationTable
     */
    public function setEquivalence(\AppBundle\Entity\QualificationEquivalence $equivalence = null)
    {
     ...
     * Get equivalence
     *
     * @return \AppBundle\Entity\QualificationEquivalence
     */

...
class UserTable implements UserInterface
{
    ...
    /**
     * @var \AppBundle\Entity\StyleGroups
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\StyleGroups")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\StudyFieldTable", inversedBy="user")
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\InterestTable", inversedBy="user")
    ...
    /**
     * @var \AppBundle\Entity\JoinWait
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\JoinWait", mappedBy="user")
     */
    private $waitingJoin;
     ...
     * Set style
     *
     * @param \AppBundle\Entity\StyleGroups $style
     *
     * @return UserTable
     */
    public function setStyle(\AppBundle\Entity\StyleGroups $style = null)
    {
        $this->style = $style;
     ...
     * Get style
     *
     * @return \AppBundle\Entity\StyleGroups
     */
     ...
     * Add field
     *
     * @param \AppBundle\Entity\StudyFieldTable $field
     *
     * @return UserTable
     */
    public function addField(\AppBundle\Entity\StudyFieldTable $field)
    {
        $this->field[] = $field;
     ...
     * @param \AppBundle\Entity\StudyFieldTable $field
     */
    public function removeField(\AppBundle\Entity\StudyFieldTable $field)
    {
     ...
     * Add interest
     *
     * @param \AppBundle\Entity\InterestTable $interest
     *
     * @return UserTable
     */
    public function addInterest(\AppBundle\Entity\InterestTable $interest)
    {
     ...
     * @param \AppBundle\Entity\InterestTable $interest
     */
    public function removeInterest(\AppBundle\Entity\InterestTable $interest)
    {
     ...
     * Set waitingJoin
     *
     * @param \AppBundle\Entity\JoinWait $waitingJoin
     *
     * @return UserTable
     */
    public function setWaitingJoin(\AppBundle\Entity\JoinWait $waitingJoin = null)
    {
     ...
     * Get waitingJoin
     *
     * @return \AppBundle\Entity\JoinWait
     */

...
class ControlPoints
{
     ...
     * @var string
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\WhiteboardSpace")
     * @ORM\Id
     * @ORM\JoinColumns({
    ...
    */
     ...
     * Set entryId
     *
     * @param \AppBundle\Entity\WhiteboardSpace $entryId
     *
     * @return ControlPoints
     */
    public function setEntryId(\AppBundle\Entity\WhiteboardSpace $entryId = null)
    {
     ...
     * Get entryId
     *
     * @return \AppBundle\Entity\WhiteboardSpace
     */

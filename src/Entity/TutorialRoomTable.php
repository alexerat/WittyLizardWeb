...
class TutorialRoomTable
{
    ...
    */
    ...
    /**
     * @var \App\Entity\TutorialServers
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\TutorialServers")
     * @ORM\JoinColumns({
     ...
     * Add waitingJoin
     *
     * @param \App\Entity\UserTable $waitingJoin
     *
     * @return TutorialRoomTable
     */
    public function addWaitingJoin(\App\Entity\UserTable $waitingJoin)
    {
     ...
     * @param \App\Entity\UserTable $waitingJoin
     */
    public function removeWaitingJoin(\App\Entity\UserTable $waitingJoin)
    {
     ...
     * Set serverId
     *
     * @param \App\Entity\TutorialServers $serverId
     *
     * @return TutorialRoomTable
     */
    public function setServer(\App\Entity\TutorialServers $serverId = null)
    {
     ...
     * Get serverId
     *
     * @return \App\Entity\TutorialServers
     */

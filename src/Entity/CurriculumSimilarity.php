...
class CurriculumSimilarity
{
     ...
     * Set currId1
     *
     * @param \App\Entity\CurriculumTable $currId1
     *
     * @return CurriculumSimilarity
     */
    public function setCurrId1(\App\Entity\CurriculumTable $currId1 = null)
    {
     ...
     * Set currId2
     *
     * @param \App\Entity\CurriculumTable $currId2
     *
     * @return CurriculumSimilarity
     */
    public function setCurrId2(\App\Entity\CurriculumTable $currId2 = null)
    {
     ...
     * Set affinity
     *
     * @param \App\Entity\CurriculumTable $affinity
     *
     * @return CurriculumSimilarity
     */
    public function setAffinity(\App\Entity\CurriculumTable $affinity = null)
    {

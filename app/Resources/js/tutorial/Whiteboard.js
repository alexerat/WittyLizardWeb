...
setSocket: function(socket)
{
    ...
    this.socket.on('TEXTBOX', function(data)
    {
        ...
        self.textInBuffer[data.serverId].editBuffer = [];
...
mouseUp: function(e)
{
    if(this.lMousePress && !this.wMousePress)
    {
        if(this.mode == 0)
        {
            ...
            {
                self.socket.emit('CURVE', {id: curveListNew.length - 1, colour: self.colour, num_points: curves.length, size: this.scaleF});
            }, 60000);

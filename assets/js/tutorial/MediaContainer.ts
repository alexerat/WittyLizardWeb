...
class UserMedia extends React.Component<any, {}>
{
    ...
    render()
    {
        ...
        if(this.props.video)
        {
            ...
            {
                let usrName = React.createElement('p', {className: "userName"}, this.props.username);
        ...
        else
        {
            ...
            {
                let usrName = React.createElement('p', {className: "userName"}, this.props.username);
                let audioUrl = window.URL.createObjectURL(mediaStream);
...
class MediaController extends React.Component<any, {}>
{
    /** React render function
     *
     * @return React.DOMElement
...
export class MediaContainer extends React.Component<any, {}>
{
    ...
    state: { data: Array<any>, localStream: MediaStream };
    ...
    constructor(props) 
    {
        ...
        this.tracks = [];
        this.state = { data: [], localStream: null };
    }
    ...
    setHandler(peerHandler: PeerHandler, userId: number)
    {
        var self = this;
    ...
    toggleVideo()
    {
        ...
        else
        {
            ...
            p.then(function(mediaStream)
            {
                ...
                localMedia.addTrack(self.videoTrack);

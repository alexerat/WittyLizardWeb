...
try {
  ...
  // @ts-ignore
  var LEFT = window.KeyboardEvent.DOM_KEY_LOCATION_LEFT;
  // @ts-ignore
  var RIGHT = window.KeyboardEvent.DOM_KEY_LOCATION_RIGHT;
  // @ts-ignore
  var NUMPAD = window.KeyboardEvent.DOM_KEY_LOCATION_NUMPAD;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
declare let components: Immutable.Map<string, BoardComponent>;
...
export class WhiteBoardController
{
    ...
    constructor(isHost: boolean, userId: number, allEdit: boolean, userEdit: boolean, workerUrl: string, componentFiles: Array<string>, components: Immutable.Map<string, BoardComponent>, testMode: boolean)
    {
        ...
        this.worker.onmessage = (e: { data: WorkerMessage }) =>
        {
            ...
            if(e.data.removeAlertCount > 0)
            {
                console.log("Handling remove alert.");
                self.removeAlert.bind(this)(e.data.removeAlertCount);
            }
    ...
    removeAlert(removalCount: number)
    {
        let newElemList = this.viewState.alertElements.slice(removalCount);
        this.setViewState({ alertElements: newElemList });
    }
    ...
    clearAlert()
    {
        this.removeAlert(this.viewState.alertElements.count());
    }
}

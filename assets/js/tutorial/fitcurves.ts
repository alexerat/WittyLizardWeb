...
export function DeCluster(d, Rsqr)
{
	var i;
	var j;
	var reduced = [];
...
export function FitCurve(d, nPts, error)
{
	segcount = 0;
	bezierData = [];
 ...
 */
function Bezier(degree: number, V: Array<Point>, t: number) : Point
{
    var i: number;
	var j: number;
    var Q: Point;	        	/* Point on curve at parameter t	*/
    var Vtemp: Array<Point> = [];		/* Local copy of control points		*/
 ...
 */
function ComputeLeftTangent(d: Array<Point>, end: number) : Point
{
    var	tHat1;
...
function ComputeRightTangent(d: Array<Point>, end: number) : Point
{
    var tHat2;
...
function ComputeCenterTangent_oud(d: Array<Point>, center: number) : [Point, Point]
{
    var	VL: Point;
	var VR: Point;
	var tHatCenter: Point = {x: 0, y: 0};
	var tHatR: Point = {x: 0, y: 0};
	var tHatL: Point = {x: 0, y: 0};
 ...
 */
function ChordLengthParameterize(d: Array<Point>, first: number, last: number) : Array<number>
{
    var	i: number;
    var u: Array<number> = [];			/*  Parameterization		*/
 ...
 *	to fitted curve.
*/
function ComputeMaxError(d: Array<Point>, first: number, last: number, bezCurve, u: Array<number>) : [number, number]
{
    var	i: number;
...
function VScale(v: Point, s: number) : Point
{
...
function VSquaredLength(v: Point) : number
{
...
function VDist(v1: Point, v2: Point) : number
{
...
function VNorm(v: Point) : Point
{
	var retV: Point = {x: 0, y: 0};
...
function VDot(v1: Point, v2: Point) : number
{

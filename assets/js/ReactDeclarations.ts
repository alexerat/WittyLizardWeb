...
namespace ReactDOM
{
    declare function findDOMNode(instance: React.ReactInstance): Element;
    ...
    declare var render: Renderer;
    declare var hydrate: Renderer;
    ...
    declare function unstable_renderSubtreeIntoContainer<T extends Element>(
